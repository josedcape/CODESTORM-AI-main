    ...
    try:
        ...
        if openai_api_key:
            try:
                ...
                # Definir el prompt del sistema según el agente
                system_prompt = {
                    'developer': "Eres un Desarrollador Experto especializado en programación y solución de problemas técnicos.",
                    'architect': "Eres un Arquitecto de Software especializado en diseño de sistemas y estructuras de aplicaciones.",
                    'advanced': "Eres un Especialista Avanzado en tecnologías complejas y soluciones optimizadas.",
                    'general': "Eres un Asistente General versátil que ayuda con diversas tareas y consultas."
                }.get(agent_id, "Eres un asistente útil y amigable.")
        ...
        # Intentar usar Anthropic si está configurado
        ...
        # Si todos los modelos fallan, devolver un error
        return jsonify({
            'success': False,
            'error': 'No se pudo conectar con ningún modelo de IA'
        }), 500
